...
from modeling_pythia_linear import PythiaLinear, ModelArgs, PythiaLinearConfig, PythiaLinearForLM
import torch
...
model = PythiaLinearForLM(PythiaLinearConfig())
data_collator = DataCollatorForLanguageModeling(tokenizer, mlm=False)

args = TrainingArguments(
    output_dir="pythia_linear",
